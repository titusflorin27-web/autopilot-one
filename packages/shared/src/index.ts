...
export interface BillingOverview { organization: { id: ID; name: string; slug: string; billingPlan: BillingPlan; billingStatus: BillingStatus; billingCurrentPeriodStart: string; billingCurrentPeriodEnd?: string | null; hasStripeCustomer?: boolean; hasStripeSubscription?: boolean; hasStripePrice?: boolean; }; limits: BillingLimits; usage: BillingLimits; remaining: BillingLimits; overLimit: Record<keyof BillingLimits, boolean>; plans: Array<{ plan: BillingPlan; limits: BillingLimits }>; paymentProvider?: { provider: "stripe"; configured: boolean; checkoutEnabled: boolean; portalEnabled: boolean; }; }
