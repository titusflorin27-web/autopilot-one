...
- SEO metadata, sitemap, robots and social preview routes
- VPS final launch QA script
...
- `docs/builds/052-seo-launch-polish.md`
- `docs/builds/053-final-launch-qa.md`
...
Public SEO metadata routes are generated by the web app:
...
Full instructions are documented in `docs/builds/052-seo-launch-polish.md`.

## Final launch QA

Run the non-destructive VPS launch QA from `/opt/autopilot-one`:

```bash
sh scripts/vps-final-launch-qa.sh
```

The script validates public web routes, SEO routes, API health, Docker services, host security services, local monitoring freshness, local backups and off-server backup markers.

Full instructions are documented in `docs/builds/053-final-launch-qa.md`.
